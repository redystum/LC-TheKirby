...
namespace TheKirby {
    ...
    public class Plugin : BaseUnityPlugin {
        ...
        private void Awake() {
            ...
            var bundleName = "modassetsthekirby";
            ...
            var TheKirby = ModAssets.LoadAsset<EnemyType>("ExampleEnemy");
            var TheKirbyTN = ModAssets.LoadAsset<TerminalNode>("ExampleEnemyTN");
            var TheKirbyTK = ModAssets.LoadAsset<TerminalKeyword>("ExampleEnemyTK");

            // Optionally, we can list which levels we want to add our enemy to, while also specifying the spawn weight for each.
            /*
            var TheKirbyLevelRarities = new Dictionary<Levels.LevelTypes, int> {
            ...
            var TheKirbyCustomLevelRarities = new Dictionary<string, int> {
                {"EGyptLevel", 50},
            ...
            */
            ...
            NetworkPrefabs.RegisterNetworkPrefab(TheKirby.enemyPrefab);
